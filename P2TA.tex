...
\subsection{Salting}
Note that the deck spawing transaction uses a different salt for both tags.
...
The asset specific salt is randomly generated and can be communicated to assed holders directly, through the OP\_RETURN message or could even be brute forced if the asset name is known and the salt has a limited size.
